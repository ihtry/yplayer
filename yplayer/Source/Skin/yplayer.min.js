! function(e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("yplayer", [], t) : "object" == typeof exports ? exports.yplayer = t() : e.yplayer = t() }(window, function() {
    return function(e) {
        var t = {};
        ...
        e.exports = function(e) {
            ...
            var t = "",
                ...
                o = e.theme,
                s = e.index;
            return n(a, function(e, n) { t += '\n<li>\n    <span class="yplayer-list-cur" style="background-color: ', t += r(e.theme || o), t += ';"></span>\n    <span class="yplayer-list-index">', t += r(n + s), t += '</span>\n    <span class="yplayer-list-title">', t += r(e.name), t += '</span>\n    <span class="yplayer-list-author">', t += r(e.artist), t += "</span>\n</li>\n" }), t
        }
    }, function(e, t, n) {
        "use strict";
        e.exports = n(15)
            ...
            return i(e, [{
                ...
                value: function() {
                    ...
                    this.player.template.list.addEventListener("click", function(t) {
                        ...
                        var i = parseInt(n.getElementsByClassName("yplayer-list-index")[0].innerHTML) - 1;
                        i !== e.index ? (e.switch(i), e.player.play()) : e.player.toggle()
                    })
                }
            }, { key: "show", value: function() { this.player.events.trigger("listshow"), this.player.template.list.classList.remove("yplayer-list-hide"), this.player.template.listOl.scrollTop = 33 * this.index } }, { key: "hide", value: function() { this.player.events.trigger("listhide"), this.player.template.list.classList.add("yplayer-list-hide") } }, { key: "toggle", value: function() { this.player.template.list.classList.contains("yplayer-list-hide") ? this.show() : this.hide() } }, {
                key: "add",
                value: function(e) {
                    ...
                    this.player.template.listOl.innerHTML += (0, a.default)({ theme: this.player.options.theme, audio: e, index: this.audios.length + 1 }), this.audios = this.audios.concat(e), t && this.audios.length > 1 && this.player.container.classList.add("yplayer-withlist"), this.player.randomOrder = r.default.randomOrder(this.audios.length), this.player.template.listCurs = this.player.container.querySelectorAll(".yplayer-list-cur"), this.player.template.listCurs[this.audios.length - 1].style.backgroundColor = e.theme || this.player.options.theme, n && ("random" === this.player.options.order ? this.switch(this.player.randomOrder[0]) : this.switch(0))
                }
            }, {
                key: "remove",
                value: function(e) {
                    if (this.player.events.trigger("listremove", { index: e }), this.audios[e])
                        if (this.audios.length > 1) {
                            var t = this.player.container.querySelectorAll(".yplayer-list li");
                            ...
                            for (var n = e; n < t.length; n++) t[n].getElementsByClassName("yplayer-list-index")[0].textContent = n;
                            1 === this.audios.length && this.player.container.classList.remove("yplayer-withlist"), this.player.template.listCurs = this.player.container.querySelectorAll(".yplayer-list-cur")
                        } else this.clear()
                }
            }, {
                key: "switch",
                value: function(e) {
                    if (this.player.events.trigger("listswitch", { index: e }), void 0 !== e && this.audios[e]) {
                        ...
                        var n = this.player.container.getElementsByClassName("yplayer-list-light")[0];
                        n && n.classList.remove("yplayer-list-light"), this.player.container.querySelectorAll(".yplayer-list li")[this.index].classList.add("yplayer-list-light"), (0, o.default)(33 * this.index, 500, null, this.player.template.listOl), this.player.setAudio(t), this.player.lrc && this.player.lrc.switch(this.index), this.player.lrc && this.player.lrc.update(0), 1 !== this.player.duration && (this.player.template.dtime.innerHTML = r.default.secondToTime(this.player.duration))
                    }
                }
            }, { key: "clear", value: function() { this.player.events.trigger("listclear"), this.index = 0, this.player.container.classList.remove("yplayer-withlist"), this.player.pause(), this.audios = [], this.player.lrc && this.player.lrc.clear(), this.player.audio.src = "", this.player.template.listOl.innerHTML = "", this.player.template.pic.style.backgroundImage = "", this.player.theme(this.player.options.theme, this.index, !1), this.player.template.title.innerHTML = "No audio", this.player.template.author.innerHTML = "", this.player.bar.set("loaded", 0, "width"), this.player.template.dtime.innerHTML = r.default.secondToTime(0) } }]), e
        }();
        t.default = l
    }, function(e, t, n) {
        "use strict";
            ...
            return i(e, [{
                ...
                value: function() {
                    var e = this,
                        ...
                        n = 0,
                        i = !1;
                    this.loadingChecker = setInterval(function() { e.enableloadingChecker && (n = e.player.audio.currentTime, i || n !== t || e.player.audio.paused || (e.player.container.classList.add("yplayer-loading"), i = !0), i && n > t && !e.player.audio.paused && (e.player.container.classList.remove("yplayer-loading"), i = !1), t = n) }, 100)
                }
            ...
            return i(e, [{
                ...
                value: function() {
                    ...
                    var t = function(t) {
                        ...
                        n = function n(i) {
                            e.player.template.volumeBarWrap.classList.remove("yplayer-volume-bar-wrap-active"), document.removeEventListener(a.default.nameMap.dragEnd, n), document.removeEventListener(a.default.nameMap.dragMove, t);
                    ...
                    this.player.template.volumeBarWrap.addEventListener(a.default.nameMap.dragStart, function() { e.player.template.volumeBarWrap.classList.add("yplayer-volume-bar-wrap-active"), document.addEventListener(a.default.nameMap.dragMove, t), document.addEventListener(a.default.nameMap.dragEnd, n) })
                }
            }, {
                key: "initOrderButton",
                value: function() {
                ...
                value: function() {
                    var e = this;
                    this.player.template.lrcButton.addEventListener("click", function() { e.player.template.lrcButton.classList.contains("yplayer-icon-lrc-inactivity") ? (e.player.template.lrcButton.classList.remove("yplayer-icon-lrc-inactivity"), e.player.lrc && e.player.lrc.show()) : (e.player.template.lrcButton.classList.add("yplayer-icon-lrc-inactivity"), e.player.lrc && e.player.lrc.hide()) })
                }
            }]), e
        }();
        t.default = s
        ...
        e.exports = function(e) {
            ...
            var t = "",
                ...
                a = e.lyrics,
                r = (e.$value, e.$index, i.$escape);
            return n(a, function(e, n) { t += "\n    <p", 0 === n && (t += ' class="yplayer-lrc-current"'), t += ">", t += r(e[1]), t += "</p>\n" }), t
        }
    }, function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
        ...
        var s = function() {
            ...
            return a(e, [{ key: "show", value: function() { this.player.events.trigger("lrcshow"), this.player.template.lrcWrap.classList.remove("yplayer-lrc-hide") } }, { key: "hide", value: function() { this.player.events.trigger("lrchide"), this.player.template.lrcWrap.classList.add("yplayer-lrc-hide") } }, { key: "toggle", value: function() { this.player.template.lrcWrap.classList.contains("yplayer-lrc-hide") ? this.show() : this.hide() } }, {
                key: "update",
                value: function() {
                    ...
                    if (this.index > this.current.length - 1 || e < this.current[this.index][0] || !this.current[this.index + 1] || e >= this.current[this.index + 1][0])
                        for (var t = 0; t < this.current.length; t++) e >= this.current[t][0] && (!this.current[t + 1] || e < this.current[t + 1][0]) && (this.index = t, this.container.style.transform = "translateY(" + 16 * -this.index + "px)", this.container.style.webkitTransform = "translateY(" + 16 * -this.index + "px)", this.container.getElementsByClassName("yplayer-lrc-current")[0].classList.remove("yplayer-lrc-current"), this.container.getElementsByTagName("p")[t].classList.add("yplayer-lrc-current"))
                }
            }, {
                key: "switch",
                value: function(e) {
        ...
        e.exports = function(e) {
            ...
            return a.fixed ? (t += '\n<div class="yplayer-list', a.listFolded && (t += " yplayer-list-hide"), t += '"', a.listMaxHeight && (t += ' style="max-height: ', t += o(a.listMaxHeight), t += '"'), t += ">\n    <ol", a.listMaxHeight && (t += ' style="max-height: ', t += o(a.listMaxHeight), t += '"'), t += ">\n        ", l(n(1)(u({ theme: a.theme, audio: a.audio, index: 1 }))), t += '\n    </ol>\n</div>\n<div class="yplayer-body">\n    <div class="yplayer-pic" style="', r && (t += "background-image: url(&quot;", t += o(r), t += "&quot;);"), t += "background-color: ", t += o(a.theme), t += ';">\n        <div class="yplayer-button yplayer-play">', t += s.play, t += '</div>\n    </div>\n    <div class="yplayer-info" style="display: none;">\n        <div class="yplayer-music">\n            <span class="yplayer-title">No audio</span>\n            <span class="yplayer-author"></span>\n        </div>\n        <div class="yplayer-controller">\n            <div class="yplayer-bar-wrap">\n                <div class="yplayer-bar">\n                    <div class="yplayer-loaded" style="width: 0"></div>\n                    <div class="yplayer-played" style="width: 0; background: ', t += o(a.theme), t += ';">\n                        <span class="yplayer-thumb" style="background: ', t += o(a.theme), t += ';">\n                            <span class="yplayer-loading-icon">', t += s.loading, t += '</span>\n                        </span>\n                    </div>\n                </div>\n            </div>\n            <div class="yplayer-time">\n                <span class="yplayer-time-inner">\n                    <span class="yplayer-ptime">00:00</span> / <span class="yplayer-dtime">00:00</span>\n                </span>\n                <span class="yplayer-icon yplayer-icon-back">\n                    ', t += s.skip, t += '\n                </span>\n                <span class="yplayer-icon yplayer-icon-play">\n                    ', t += s.play, t += '\n                </span>\n                <span class="yplayer-icon yplayer-icon-forward">\n                    ', t += s.skip, t += '\n                </span>\n                <div class="yplayer-volume-wrap">\n                    <button type="button" class="yplayer-icon yplayer-icon-volume-down">\n                        ', t += s.volumeDown, t += '\n                    </button>\n                    <div class="yplayer-volume-bar-wrap">\n                        <div class="yplayer-volume-bar">\n                            <div class="yplayer-volume" style="height: 80%; background: ', t += o(a.theme), t += ';"></div>\n                        </div>\n                    </div>\n                </div>\n                <button type="button" class="yplayer-icon yplayer-icon-order">\n                    ', "list" === a.order ? t += s.orderList : "random" === a.order && (t += s.orderRandom), t += '\n                </button>\n                <button type="button" class="yplayer-icon yplayer-icon-loop">\n                    ', "one" === a.loop ? t += s.loopOne : "all" === a.loop ? t += s.loopAll : "none" === a.loop && (t += s.loopNone), t += '\n                </button>\n                <button type="button" class="yplayer-icon yplayer-icon-menu">\n                    ', t += s.menu, t += '\n                </button>\n                <button type="button" class="yplayer-icon yplayer-icon-lrc">\n                    ', t += s.lrc, t += '\n                </button>\n            </div>\n        </div>\n    </div>\n    <div class="yplayer-notice"></div>\n    <div class="yplayer-miniswitcher"><button class="yplayer-icon">', t += s.right, t += '</button></div>\n</div>\n<div class="yplayer-lrc">\n    <div class="yplayer-lrc-contents" style="transform: translateY(0); -webkit-transform: translateY(0);"></div>\n</div>\n') : (t += '\n<div class="yplayer-body">\n    <div class="yplayer-pic" style="', r && (t += "background-image: url(&quot;", t += o(r), t += "&quot;);"), t += "background-color: ", t += o(a.theme), t += ';">\n        <div class="yplayer-button yplayer-play">', t += s.play, t += '</div>\n    </div>\n    <div class="yplayer-info">\n        <div class="yplayer-music">\n            <span class="yplayer-title">No audio</span>\n            <span class="yplayer-author"></span>\n        </div>\n        <div class="yplayer-lrc">\n            <div class="yplayer-lrc-contents" style="transform: translateY(0); -webkit-transform: translateY(0);"></div>\n        </div>\n        <div class="yplayer-controller">\n            <div class="yplayer-bar-wrap">\n                <div class="yplayer-bar">\n                    <div class="yplayer-loaded" style="width: 0"></div>\n                    <div class="yplayer-played" style="width: 0; background: ', t += o(a.theme), t += ';">\n                        <span class="yplayer-thumb" style="background: ', t += o(a.theme), t += ';">\n                            <span class="yplayer-loading-icon">', t += s.loading, t += '</span>\n                        </span>\n                    </div>\n                </div>\n            </div>\n            <div class="yplayer-time">\n                <span class="yplayer-time-inner">\n                    <span class="yplayer-ptime">00:00</span> / <span class="yplayer-dtime">00:00</span>\n                </span>\n                <span class="yplayer-icon yplayer-icon-back">\n                    ', t += s.skip, t += '\n                </span>\n                <span class="yplayer-icon yplayer-icon-play">\n                    ', t += s.play, t += '\n                </span>\n                <span class="yplayer-icon yplayer-icon-forward">\n                    ', t += s.skip, t += '\n                </span>\n                <div class="yplayer-volume-wrap">\n                    <button type="button" class="yplayer-icon yplayer-icon-volume-down">\n                        ', t += s.volumeDown, t += '\n                    </button>\n                    <div class="yplayer-volume-bar-wrap">\n                        <div class="yplayer-volume-bar">\n                            <div class="yplayer-volume" style="height: 80%; background: ', t += o(a.theme), t += ';"></div>\n                        </div>\n                    </div>\n                </div>\n                <button type="button" class="yplayer-icon yplayer-icon-order">\n                    ', "list" === a.order ? t += s.orderList : "random" === a.order && (t += s.orderRandom), t += '\n                </button>\n                <button type="button" class="yplayer-icon yplayer-icon-loop">\n                    ', "one" === a.loop ? t += s.loopOne : "all" === a.loop ? t += s.loopAll : "none" === a.loop && (t += s.loopNone), t += '\n                </button>\n                <button type="button" class="yplayer-icon yplayer-icon-menu">\n                    ', t += s.menu, t += '\n                </button>\n                <button type="button" class="yplayer-icon yplayer-icon-lrc">\n                    ', t += s.lrc, t += '\n                </button>\n            </div>\n        </div>\n    </div>\n    <div class="yplayer-notice"></div>\n    <div class="yplayer-miniswitcher"><button class="yplayer-icon">', t += s.right, t += '</button></div>\n</div>\n<div class="yplayer-list', a.listFolded && (t += " yplayer-list-hide"), t += '"', a.listMaxHeight && (t += ' style="max-height: ', t += o(a.listMaxHeight), t += '"'), t += ">\n    <ol", a.listMaxHeight && (t += ' style="max-height: ', t += o(a.listMaxHeight), t += '"'), t += ">\n        ", l(n(1)(u({ theme: a.theme, audio: a.audio, index: 1 }))), t += "\n    </ol>\n</div>\n"), t
        }
    }, function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
        ...
        var s = function() {
            ...
            return i(e, [{
                ...
                value: function() {
                    var e = "";
                    this.options.audio.length && (e = "random" === this.options.order ? this.options.audio[this.randomOrder[0]].cover : this.options.audio[0].cover), this.container.innerHTML = (0, r.default)({ options: this.options, icons: a.default, cover: e, getObject: function(e) { return e } }), this.lrc = this.container.querySelector(".yplayer-lrc-contents"), this.lrcWrap = this.container.querySelector(".yplayer-lrc"), this.ptime = this.container.querySelector(".yplayer-ptime"), this.info = this.container.querySelector(".yplayer-info"), this.time = this.container.querySelector(".yplayer-time"), this.barWrap = this.container.querySelector(".yplayer-bar-wrap"), this.button = this.container.querySelector(".yplayer-button"), this.body = this.container.querySelector(".yplayer-body"), this.list = this.container.querySelector(".yplayer-list"), this.listOl = this.container.querySelector(".yplayer-list ol"), this.listCurs = this.container.querySelectorAll(".yplayer-list-cur"), this.played = this.container.querySelector(".yplayer-played"), this.loaded = this.container.querySelector(".yplayer-loaded"), this.thumb = this.container.querySelector(".yplayer-thumb"), this.volume = this.container.querySelector(".yplayer-volume"), this.volumeBar = this.container.querySelector(".yplayer-volume-bar"), this.volumeButton = this.container.querySelector(".yplayer-time button"), this.volumeBarWrap = this.container.querySelector(".yplayer-volume-bar-wrap"), this.loop = this.container.querySelector(".yplayer-icon-loop"), this.order = this.container.querySelector(".yplayer-icon-order"), this.menu = this.container.querySelector(".yplayer-icon-menu"), this.pic = this.container.querySelector(".yplayer-pic"), this.title = this.container.querySelector(".yplayer-title"), this.author = this.container.querySelector(".yplayer-author"), this.dtime = this.container.querySelector(".yplayer-dtime"), this.notice = this.container.querySelector(".yplayer-notice"), this.miniSwitcher = this.container.querySelector(".yplayer-miniswitcher"), this.skipBackButton = this.container.querySelector(".yplayer-icon-back"), this.skipForwardButton = this.container.querySelector(".yplayer-icon-forward"), this.skipPlayButton = this.container.querySelector(".yplayer-icon-play"), this.lrcButton = this.container.querySelector(".yplayer-icon-lrc")
                }
            }]), e
        }();
        t.default = s
        ...
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }), t.default = function(e) { var t = { container: e.element || document.getElementsByClassName("yplayer")[0], mini: e.narrow || e.fixed || !1, fixed: !1, autoplay: !1, mutex: !0, lrcType: e.showlrc || e.lrc || 0, preload: "auto", theme: "#b7daff", loop: "all", order: "list", volume: .7, listFolded: e.fixed, listMaxHeight: e.listmaxheight || "250px", audio: e.music || [], storageName: "yplayer-setting" }; for (var n in t) t.hasOwnProperty(n) && !e.hasOwnProperty(n) && (e[n] = t[n]); return "[object Array]" !== Object.prototype.toString.call(e.audio) && (e.audio = [e.audio]), e.audio.map(function(e) { return e.name = e.name || e.title || "Audio name", e.artist = e.artist || e.author || "Audio artist", e.cover = e.cover || e.pic, e.type = e.type || "normal", e }), e.audio.length <= 1 && "one" === e.loop && (e.loop = "all"), e }
        ...
        var m = [],
            g = function() {
                function e(t) {
                    if (function(e, t) { if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, e), this.options = (0, s.default)(t), this.container = this.options.container, this.paused = !0, this.playedPromise = a.default.resolve(), this.mode = "normal", this.randomOrder = r.default.randomOrder(this.options.audio.length), this.container.classList.add("yplayer"), this.options.lrcType && !this.options.fixed && this.container.classList.add("yplayer-withlrc"), this.options.audio.length > 1 && this.container.classList.add("yplayer-withlist"), r.default.isMobile && this.container.classList.add("yplayer-mobile"), this.arrow = this.container.offsetWidth <= 300, this.arrow && this.container.classList.add("yplayer-arrow"), this.container = this.options.container, 2 === this.options.lrcType || !0 === this.options.lrcType)
                        for (var n = this.container.getElementsByClassName("yplayer-lrc-content"), i = 0; i < n.length; i++) this.options.audio[i] && (this.options.audio[i].lrc = n[i].innerHTML);
                    this.template = new l.default({ container: this.container, options: this.options, randomOrder: this.randomOrder }), this.options.fixed && (this.container.classList.add("yplayer-fixed"), this.template.body.style.width = this.template.body.offsetWidth - 18 + "px"), this.options.mini && (this.setMode("mini"), this.template.info.style.display = "block"), this.template.info.offsetWidth < 200 && this.template.time.classList.add("yplayer-time-narrow"), this.options.lrcType && (this.lrc = new p.default({ container: this.template.lrc, async: 3 === this.options.lrcType, player: this })), this.events = new y.default, this.storage = new c.default(this), this.bar = new u.default(this.template), this.controller = new d.default(this), this.timer = new h.default(this), this.list = new f.default(this), this.initAudio(), this.bindEvents(), "random" === this.options.order ? this.list.switch(this.randomOrder[0]) : this.list.switch(0), this.options.autoplay && this.play(), m.push(this)
                }
                return i(e, [{
                    key: "initAudio",
                    value: function() {
                    ...
                    value: function() {
                        var e = this;
                        if (this.paused && (this.paused = !1, this.template.button.classList.remove("yplayer-play"), this.template.button.classList.add("yplayer-pause"), this.template.button.innerHTML = "", setTimeout(function() { e.template.button.innerHTML = o.default.pause }, 100), this.template.skipPlayButton.innerHTML = o.default.pause), this.timer.enable("loading"), this.options.mutex)
                    ...
                    value: function() {
                        var e = this;
                        this.paused || (this.paused = !0, this.template.button.classList.remove("yplayer-pause"), this.template.button.classList.add("yplayer-play"), this.template.button.innerHTML = "", setTimeout(function() { e.template.button.innerHTML = o.default.play }, 100), this.template.skipPlayButton.innerHTML = o.default.play), this.container.classList.remove("yplayer-loading"), this.timer.disable("loading")
                    }
                }, { key: "pause", value: function() { this.setUIPaused(), this.audio.pause() } }, { key: "switchVolumeIcon", value: function() { this.volume() >= .95 ? this.template.volumeButton.innerHTML = o.default.volumeUp : this.volume() > 0 ? this.template.volumeButton.innerHTML = o.default.volumeDown : this.template.volumeButton.innerHTML = o.default.volumeOff } }, { key: "volume", value: function(e, t) { return e = parseFloat(e), isNaN(e) || (e = Math.max(e, 0), e = Math.min(e, 1), this.bar.set("volume", e, "height"), t || this.storage.set("volume", e), this.audio.volume = e, this.audio.muted && (this.audio.muted = !1), this.switchVolumeIcon()), this.audio.muted ? 0 : this.audio.volume } }, { key: "on", value: function(e, t) { this.events.on(e, t) } }, { key: "toggle", value: function() { this.template.button.classList.contains("yplayer-play") ? this.play() : this.template.button.classList.contains("yplayer-pause") && this.pause() } }, { key: "switchAudio", value: function(e) { this.list.switch(e) } }, { key: "addAudio", value: function(e) { this.list.add(e) } }, { key: "removeAudio", value: function(e) { this.list.remove(e) } }, { key: "destroy", value: function() { m.splice(m.indexOf(this), 1), this.pause(), this.container.innerHTML = "", this.audio.src = "", this.timer.destroy(), this.events.trigger("destroy") } }, {
                    key: "setMode",
                    value: function() {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "normal";
                        this.mode = e, "mini" === e ? this.container.classList.add("yplayer-narrow") : "normal" === e && this.container.classList.remove("yplayer-narrow")
                    }
                }, {
                    key: "notice",
                    value: function(e) {
